...
export function SignupScreen() {
  ...
  return (
    <div className="login-shell relative flex min-h-dvh overflow-x-hidden overflow-y-auto">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 items-start px-4 py-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(1.5rem,env(safe-area-inset-top))] sm:items-center sm:px-8 sm:py-10 lg:px-12">
