...
export const products: Product[] = [
  ...
  { id: "bar-nuts", categoryId: "bar-buddies", name: "Bar Nuts", price: 3.5 },
  { id: "olives", categoryId: "bar-buddies", name: "Marinated Olives", price: 4.25 },
  { id: "loaded-fries", categoryId: "bar-buddies", name: "Loaded Fries", price: 6.5 },
